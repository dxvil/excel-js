...
var Excel = /*#__PURE__*/function () {
  function Excel(selector, options) {
    ...
    this.$el = Object(_core_dom__WEBPACK_IMPORTED_MODULE_0__["$"])(selector);
  ...
  _createClass(Excel, [{
    ...
    value: function getRoot() {
      ...
      this.components = this.components.map(function (Component) {
        ...
        var component = new Component($el); // // debug
        // if (component.name) {
...
/* harmony import */ var _core_ExcelComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @core/ExcelComponent */ "./core/ExcelComponent.js");
/* harmony import */ var _components_table_table_template__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/components/table/table.template */ "./components/table/table.template.js");
...
var Table = /*#__PURE__*/function (_ExcelComponent) {
  ...
  _createClass(Table, [{
    key: "toHTML",
    value: function toHTML() {
      return Object(_components_table_table_template__WEBPACK_IMPORTED_MODULE_1__["createTable"])(20);
    }
  }, {
    key: "onMousedown",
    value: function onMousedown(event) {
      ...
      if (event.target.dataset.resize) {
        var $resizer = Object(_core_dom__WEBPACK_IMPORTED_MODULE_2__["$"])(event.target);
        ...
        document.onmouseup = function () {
          ...
          if (type === "col") {
            ...
            _this.$root.findAll("[data-col=\"".concat($parent.data.col, "\"]")).forEach(function (el) {
...
function toCell(_, col) {
  return "\n    <div class=\"cell\" contenteditable data-col=\"".concat(col, "\"></div>\n  ");
}
